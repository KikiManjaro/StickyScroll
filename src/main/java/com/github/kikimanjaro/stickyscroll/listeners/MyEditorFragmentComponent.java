...
public final class MyEditorFragmentComponent extends JPanel {
    ...
    static LightweightHint showEditorFragmentHintAt(Editor editor,
        ...
        MyEditorFragmentComponent fragmentComponent = createEditorFragmentComponent(editor, startLine, endLine, showFolding, true,
        ...
        hint.getComponent().setBorder(JBUI.Borders.empty());
        return hint;
    }

    public static MyEditorFragmentComponent createEditorFragmentComponent(Editor editor,
                                                                          int startLine,
                                                                          int endLine,
    ...
    private static MyEditorFragmentComponent createEditorFragmentComponent(Editor editor,
                                                                           int startLine,
                                                                           int endLine,
                                                                           boolean showFolding, boolean showGutter,
                                                                           boolean useCaretRowBackground) {
        ...
        MyEditorFragmentComponent fragmentComponent = new MyEditorFragmentComponent(editorEx, startLine, endLine, showFolding, showGutter);
