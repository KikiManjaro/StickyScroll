...
@NonNls
const val BUNDLE: String = "messages.StickyScrollBundle"

object StickyScrollBundle : AbstractBundle(BUNDLE) {
...
fun message(@PropertyKey(resourceBundle = BUNDLE) key: String, vararg params: Any): String {
	return StickyScrollBundle.getAdaptedMessage(key, *params)
}

fun messagePointer(@PropertyKey(resourceBundle = BUNDLE) key: String, vararg params: Any): Supplier<String> {
	return StickyScrollBundle.getAdaptedLazyMessage(key, *params)
}